        ...
        <v-row flex align-center>       
            <v-col xs12 sm4 elevation-6>         
                <v-card style="height:75vh;">           
                    <v-card-title class="justify-center display-1 purple--text">Register</v-card-title>  
                                ...
                                <v-form v-model="valid" ref="form">                
                                    ...
                                    ></v-text-field>                  
                                        <v-row justify="center">                   
                                            <v-btn 
                                            @click="register"                     
                                            :class=" { 'purple darken-4 white--text': valid, 
                                            disabled: !valid }"                     :disabled="valid===false"                   
                                            >Register</v-btn>                 
                                        </v-row>               
                                </v-form>             
                            </div>             
